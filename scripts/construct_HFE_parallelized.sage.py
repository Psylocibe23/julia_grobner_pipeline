...
_sage_const_2048 = Integer(2048); _sage_const_256 = Integer(256); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p6 = RealNumber('0.6'); _sage_const_2 = Integer(2); _sage_const_0p70 = RealNumber('0.70'); _sage_const_0p60 = RealNumber('0.60'); _sage_const_20 = Integer(20); _sage_const_16 = Integer(16); _sage_const_1023 = Integer(1023); _sage_const_32 = Integer(32); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_8 = Integer(8)###############################################################################
