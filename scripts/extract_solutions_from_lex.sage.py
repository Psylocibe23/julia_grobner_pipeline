...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_10_000_000 = Integer(10_000_000); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5)###############################################################################
...
def solve_shape_lex_branch(R, variables, G_lex, F, log=None,
    ...
    if not univariates:
        ...
        univariates = [g for g in El.gens() if set(map(str, g.variables())) <= {variables[-_sage_const_1 ]}]
    if not univariates:
        ...
        while stack:
            ...
            if poly is None:
                ...
                if not cands:
                    ...
                    cand_vals = [F(_sage_const_0 ), F(_sage_const_1 )] if F.order() == _sage_const_2  else [F(_sage_const_0 )]
            ...
            try:
                ...
                if F.order() == _sage_const_2 :
                    cand_vals = [F(_sage_const_0 ), F(_sage_const_1 )]
                else:
...
def main():
    ...
    while i < len(sys.argv):
        ...
        if a == "--first-only":
            ...
            if "=" in a:
                max_solutions = int(a.split("=",_sage_const_1 )[_sage_const_1 ])
                i += _sage_const_1 
            else:
                max_solutions = int(sys.argv[i+_sage_const_1 ]); i += _sage_const_2 
        elif a.startswith("--node-limit"):
            if "=" in a:
                node_limit = int(a.split("=",_sage_const_1 )[_sage_const_1 ])
                i += _sage_const_1 
            else:
                node_limit = int(sys.argv[i+_sage_const_1 ]); i += _sage_const_2 
        elif a == "--no-fallback":
            no_fallback = True
            i += _sage_const_1 
        else:
