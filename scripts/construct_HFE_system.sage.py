...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_20 = Integer(20); _sage_const_32 = Integer(32)################################################################################
...
def construct_extension_field(q, n, prim_poly=None):
    ...
    if prim_poly is not None:
        K = GF(Fq**n, modulus=prim_poly, names=('a',)); (a,) = K._first_ngens(1)
...
def extract_coordinate_polys(fy, a, n, xvars):
    ...
    result = [R(_sage_const_0 ) for _ in range(n)]  # polynomials for each coordinate
...
if __name__ == "__main__":
    ...
    q = _sage_const_2              # Field characteristic (2 for binary HFE)
    n = _sage_const_20              # Number of variables 
    d = _sage_const_32             # Maximum degree of secret univariate polynomial F
    # ------------------------------------------------
